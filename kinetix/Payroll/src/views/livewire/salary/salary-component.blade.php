        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group row"><label class="col-sm-3 col-form-label">Basic Salary</label>
                    <div class="col-sm-12">
                        <input wire:model="basic_salary" type="number"
    ...
    <div class="card">
        <div class="card-body">
            <div class="d-flex justify-content-between mb-2">
                ...
                <div class="">
                    <button wire:click.prevent="create_salary_sheet" class="btn btn-success">CREATE SALARY SHEET
                    </button>
                </div>
            </div>
            <div class="row">
                                    ...
                                    <table id="order-listing" class="table dataTable no-footer " role="grid"
                                        ...
                                        @foreach ($all_employee as $employee)
                                            <tr role="row" class="odd">
                                                ...
                                                <td>{{ $employee->emp_id }}
                                                    <br>{{ $employee->salaryInfo->employee_type ?? 'N/A' }}
                                                </td>
                                                <td>{{ $employee->department->department }}
                                                    <br> {{ $employee->designation->name }}
                                                </td>
