        ...
        <form class="forms-sample" wire:submit.prevent>
            <div class="form-group row">
                ...
                <input type="text" wire:model="department" class="form-control
                    @error('department') is-invalid @enderror" id="department" placeholder="Department Name">
                    @error('department')
...
{{--                    </div>--}}
            ...
            <div class="col-sm-7 offset-sm-3">
                <button wire:click.prevent="update" type="submit" class="btn btn-info btn-block">Update</button>
            </div>
        </form>
    </div>
</div>
